...
const sideBarLinks = [
  ...
  },
  {
    href: "/swap",
    link: "Swap",
    icon: `<svg xmlns="http://www.w3.org/2000/svg" version="1.1" x="0px" y="0px" viewBox="0 0 100 125" style="enable-background:new 0 0 100 100;" xml:space="preserve"><path d="M14.7,45.9h39.1H63h23.4c1.2,0,1.8-1.4,0.9-2.2L55.7,14.1c-0.8-0.8-2.2-0.2-2.2,1l0.2,17.9h-39c-1.3,0-2.4,1.1-2.4,2.4v8.3  C12.3,44.9,13.4,45.9,14.7,45.9z"/><path d="M87.7,64.7v-8.3c0-1.3-1.1-2.4-2.4-2.4H46.2H37H13.6c-1.2,0-1.8,1.4-0.9,2.2l31.6,29.6c0.8,0.8,2.2,0.2,2.2-1l-0.2-17.9h39  C86.6,67.1,87.7,66.1,87.7,64.7z"/><text x="0" y="115"</svg>`,
  },
  {
    href: "/exchange",
    link: "Exchange",
